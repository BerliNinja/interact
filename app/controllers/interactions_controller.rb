class InteractionsController < ApplicationController
  ...
  def index
    ...
    @markers = Gmaps4rails.build_markers(@interactions) do |interaction, marker|
      marker.lat interaction.latitude
      marker.lng interaction.longitude
    end
  end
  ...
  private
    ...
    def interaction_params
      params.require(:interaction).permit(:interaction, :description, :picture, :interactor, :interacted, :address)
    end
end
